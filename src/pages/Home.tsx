          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="hover:shadow-lg transition-shadow w-full min-w-0">
                  <CardContent className="p-2 sm:p-4 md:p-6 text-center">
                    <h3 className="font-montserrat font-semibold text-lg mb-2 truncate">{t('home.resources.manualTitle')}</h3>
                    <p className="text-gray-600 text-sm truncate">{t('home.resources.manualDesc')}</p>
                  </CardContent>
                </Card>
                <Card className="hover:shadow-lg transition-shadow w-full min-w-0">
                  <CardContent className="p-2 sm:p-4 md:p-6 text-center">
                    <h3 className="font-montserrat font-semibold text-lg mb-2 truncate">{t('home.resources.trainingTitle')}</h3>
                    <p className="text-gray-600 text-sm truncate">{t('home.resources.trainingDesc')}</p>
                  </CardContent>
                </Card>
                <Card className="hover:shadow-lg transition-shadow w-full min-w-0">
                  <CardContent className="p-2 sm:p-4 md:p-6 text-center">
                    <h3 className="font-montserrat font-semibold text-lg mb-2 truncate">{t('home.resources.communityTitle')}</h3>
                    <p className="text-gray-600 text-sm truncate">{t('home.resources.communityDesc')}</p>
                  </CardContent>
                </Card>
              </div>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* Mission */}
            <Card className="h-full hover:shadow-lg transition-shadow duration-300 animate-slide-in-left w-full min-w-0">
              <CardContent className="p-2 sm:p-4 md:p-6 text-center">
            ...
            {/* Vision */}
            <Card className="h-full hover:shadow-lg transition-shadow duration-300 animate-fade-in w-full min-w-0">
              <CardContent className="p-2 sm:p-4 md:p-6 text-center">
            ...
            {/* Values */}
            <Card className="h-full hover:shadow-lg transition-shadow duration-300 animate-slide-in-right w-full min-w-0">
              <CardContent className="p-2 sm:p-4 md:p-6 text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {interventionAreas.map((area, index) => (
              <Card
                key={area.title}
                className="h-full hover:shadow-xl transition-all duration-300 hover:-translate-y-2 animate-scale-in w-full min-w-0"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <CardContent className="p-2 sm:p-4 md:p-6 text-center">
                  <div className="w-16 h-16 bg-gray-50 rounded-full flex items-center justify-center mx-auto mb-4">
                    <img src={area.image} alt={area.title} className="max-w-full h-auto w-12 h-12 object-contain" />
                  </div>
